...
public class VpnConnectManager implements Runnable {

    /**
     * Callback interface to let the {@link com.lucky.androidlearndemo.ui.service.NewVpnService} know about new connections
    ...
    public VpnConnectManager(final VpnService service, final int connectionId,
    ...
    public void run() {
        try {
            ...
            InetAddress serverAddr = InetAddress.getByName(mServerName);
            final SocketAddress serverAddress = new InetSocketAddress(serverAddr, mServerPort);
    ...
    private final String getTag() {
        return VpnConnectManager.class.getSimpleName() + "[" + mConnectionId + "]";
    }
}
